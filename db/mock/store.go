...
// Source: github.com/myboilerplate/golang-simple-bank/db/sqlc (interfaces: Store)
...
// TransferAccountBalance mocks base method.
func (m *MockStore) TransferAccountBalance(arg0 context.Context, arg1 db.TransferAccountBalanceParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferAccountBalance", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// TransferAccountBalance indicates an expected call of TransferAccountBalance.
func (mr *MockStoreMockRecorder) TransferAccountBalance(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "TransferAccountBalance", reflect.TypeOf((*MockStore)(nil).TransferAccountBalance), arg0, arg1)
}
